...
export const eventModif = (event) => (
  {
    ...
    timeZone: event.dates.timezone?event.dates.timezone:event._embedded.venues[0].timezone,
    city: event._embedded?event._embedded.venues[0].city.name:event.place.city.name,
    country: event._embedded?event._embedded.venues[0].city.name:event.place.country.name,
    name: event.name,
    places: event._embedded?event._embedded.venues[0].name:event.place.address.line1,
